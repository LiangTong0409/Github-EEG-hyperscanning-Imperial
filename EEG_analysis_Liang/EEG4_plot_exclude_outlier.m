...
% 4. EEG plot script (exclude participant pair 1 for left hand)
...
channel=1; %(2 6 15 24 27) (17 13) 46 1 
feature=2;

data=zeros(253,7);%% exclusde pair 1
data(1:253,1)=IBS_Vision(channel,24:276,feature);
data(1:253,2)=IBS_Passive(channel,24:276,feature);
data(1:253,3)=IBS_Hand(channel,24:276,feature);
data(1:253,4)=IBS_Solo(channel,23:275,feature);% C_solo reject 1 trial pair
data(1:253,5)=IBS_RP(channel,24:276,feature);
data(1:253,6)=IBS_HP(channel,24:276,feature);
data(1:253,7)=IBS_TG(channel,24:276,feature);
...
hold on
% scatter 
x = [ones(1,253) 2*ones(1,253) 3*ones(1,253) 4*ones(1,253) 5*ones(1,253) 6*ones(1,253) 7*ones(1,253)];
y1 = data(:,1);
y2 = data(:,2);
y3 = data(:,3);
y4 = data(:,4);
...
%% Vision and Passive no haptic feedback vs all haptic feedback 
channel=15; %(6 39 15 24 27)(13 17)
feature=1;
